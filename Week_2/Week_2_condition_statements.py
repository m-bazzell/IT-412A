...
for total in underpaid_salaries: 
...
print("This is the list of floats: " + str(float_list))
print("This is the list of booleans: " + str(bool_list))
print("This is the list of something else: " + str(something_else_list))

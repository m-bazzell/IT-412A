...
#begin processing second part of phone number
    ...
    phone_numbers.append({'area code': area_code, 'First part': phone_first_part, 'second part': phone_second_part})
